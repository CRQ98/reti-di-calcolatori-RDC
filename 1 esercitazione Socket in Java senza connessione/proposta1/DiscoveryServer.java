	...
	public static void main(String[] args) {
		...
		for (int i = 1; i < args.length; i = i + 2) {
			...
			try {
				...
				if (portCorr <= 1024 || portCorr > 65535||ports.contains(portCorr)) {
		...
		//non è una buona soluzione xk comunque gli argomenti validi con conincide con l'ordine di args[]
		//e nomero di validArgs non è giusto.
		//Una soluzione interigente è di metter i arg validi in un arrayList e ciclare su di esso
